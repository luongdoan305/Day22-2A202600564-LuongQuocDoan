...
PROMPT_V1_NAME = "luong-quoc-doan-day22-rag-prompt-v1"
PROMPT_V2_NAME = "luong-quoc-doan-day22-rag-prompt-v2"
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V1_NAME,
            object=PROMPT_V1,
            description="V1 - câu trả lời ngắn gọn, thân thiện",
        )
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="V2 - câu trả lời chuyên nghiệp, có cấu trúc",
        )
